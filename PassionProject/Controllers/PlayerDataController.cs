...
namespace PassionProject.Controllers
{
    public class PlayerDataController : ApiController
    {
        ...
        /// </summary>
        /// <returns>A list of players including their ID, Name, Number, Position, Injury Description, TeamId</returns>
        /// <example>
        ...
        /// <summary>
        /// Gets a list or Injuries in the database alongside a status code (200 OK).
        /// </summary>
        /// <param name="id">The player id</param>
        /// <returns>A list of Injuries including their ID, and name.</returns>
        /// <example>
        /// GET: api/InjuryData/GetInjuriesForPlayer
        /// </example>
